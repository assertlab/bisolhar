...
### v2.2.0 - Testes e Qualidade (Planejado: Janeiro 2026)
- [ ] **Testes Unitários**: Implementação de Vitest para componentes e hooks
- [ ] **Testes E2E**: Playwright ou Cypress para fluxos críticos
- [ ] **TypeScript**: Migração gradual para TypeScript
